...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		...
		//5개의 산술연살자를 사용해 5개의 연산을 수행 후 출력해주세요.
		result = 10+20;
		System.out.println(result);
		result = 30-20;
		System.out.println(result);
		...
		//타입을 선택할떄 연산의 범위를 고려해야한다.
		
		//다음을 한줄식 계산해서 최종 결과값을 출력해주세요.
		//1. 123456 + 654321
		//2. 1번의 결과값 * 123456
		//3. 2번의 결과값 / 123456
		//4. 3번의 결과값 -654321
...
//		System.out.println(avg);
		...
		//랜덤 - 0에서부터 1미만 까지 발생시킴
		System.out.println((int)(Math.random() * 100) + 1); //1부터 100까지 소수점없이 랜덤한 수를 얻을 수 있다.
